...
public class LdrhRegState extends OpState {
  ...
  public void translate(final DisassemblerConfig config, final TranslatorOutput output, final boolean hasDependant) {
    output.addLine(this, "%s = MEMORY.ref(2, %s + %s).getUnsigned();".formatted(this.dst.fullName(), this.base.fullName(), this.offset.fullName()));
  }
