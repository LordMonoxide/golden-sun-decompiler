...
public class BicAluState extends OpState {
  public final Register dst;
  public final Register src;

  public BicAluState(final int address, final OpType opType, final Register dst, final Register src) {
  ...
  public void translate(final DisassemblerConfig config, final TranslatorOutput output, final boolean hasDependant, final Set<OpState> dependencies) {
    if(hasDependant) {
      output.addLine(this, "%1$s = CPU.bicT(%1$s, %2$s);".formatted(this.dst.fullName(), this.src.fullName()));
    } else {
