...
public class MulAluState extends OpState {
  public final Register dst;
  public final Register src;

  public MulAluState(final DisassemblyRange range, final int address, final OpType opType, final Register dst, final Register src) {
