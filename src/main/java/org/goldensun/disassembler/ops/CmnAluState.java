...
public class CmnAluState extends OpState {
  public final Register a;
  public final Register b;

  public CmnAluState(final int address, final OpType opType, final Register a, final Register b) {
  ...
  public void translate(final DisassemblerConfig config, final TranslatorOutput output, final boolean hasDependant, final Set<OpState> dependencies) {
    if(!hasDependant) {
      output.addLabel(this.address, "//TODO no dependant found for cmn");
    }

    output.addLine(this, "CPU.cmnT(%s, %s);".formatted(this.a.fullName(), this.b.fullName()));
  }
